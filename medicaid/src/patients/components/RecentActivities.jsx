export default function RecentActivities() {
  const activities = [
    { title: "Prescription Refilled", desc: "Medication: Aspirin 100mg", time: "2 hours ago" },
    { title: "Appointment Refilled", desc: "Dr. Smith - General Checkup", time: "1 day ago" },
    { title: "Medical Record Update", desc: "Lab results added", time: "3 days ago" },
  ];

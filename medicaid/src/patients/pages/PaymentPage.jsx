...
export default function PaymentPage() {
  ...
  const handlePaymentSuccess = () => {
    ...
    window.location.href = "/patient-appointments-page";   // ← works instantly, no routing needed
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <Sidebar isOpen={sidebarOpen} toggleSidebar={() => setSidebarOpen(!sidebarOpen)} activeItem="Appointments" />
            ...
            <>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="flex justify-between"><span>Doctor:</span> <span className="font-medium">Dr. James Mitchell</span></div>
                  <div className="flex justify-between"><span>Date & Time:</span> <span className="font-medium">Dec 15, 2025 at 10:00 AM</span></div>
                  <div className="flex justify-between"><span>Location:</span> <span className="font-medium">Downtown Medical Center</span></div>
                </div>
              </div>

              <div className="bg-blue-50 border border-blue-200 rounded-xl px-6 py-4 flex items-center gap-3 mb-8">
                <div className="bg-blue-600 text-white p-3 rounded-lg text-xl font-bold">P</div>
                <div>
                  <p className="font-medium text-blue-900">Paystack</p>
                  <p className="text-sm text-blue-700">All transactions are secure and encrypted</p>
                </div>
              </div>

              <h3 className="text-xl font-bold text-gray-900 mb-6">Choose How You Want to Pay</h3>
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-2xl p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between"><span>Plan:</span> <span>One Month Consultation</span></div>
                      <div className="flex justify-between"><span>Amount:</span> <span>₦100,000</span></div>
                    </div>
                  </div>
                  ...
                  <div className="text-center text-sm text-gray-500">
                    <Lock size={16} className="inline text-green-500" /> 256-bit SSL encrypted
                  </div>
                </div>
              </div>
            </>
